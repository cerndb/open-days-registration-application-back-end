...
public class VisitorsDetailModel {

    @JsonProperty("visitorDetails")
    public List<VisitorDetailModel> visitorsDetails;

    @JsonProperty("fastTrackAllowed")
    public boolean fastTrackAllowed;

    @JsonProperty("groupHasDisabledPerson")
    public boolean groupHasDisabledPerson;

    public VisitorsDetailModel() {
        this.visitorsDetails = new ArrayList<>();
        this.groupHasDisabledPerson = false;
    }

    public VisitorsDetailModel setFastTrackAllowed(boolean fastTrackAllowed) {
        this.fastTrackAllowed = fastTrackAllowed;
        return this;
    }

    public VisitorsDetailModel setGroupHasDisabledPerson(boolean groupHasDisabledPerson) {
